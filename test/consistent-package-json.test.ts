  ...
  ({packageName, packageJSONPath, packageJSON, expectedPackageJSON}) => {
    describe(`${packageName}`, () => {
      ...
      describe(packageJSONPath, () => {
        ...
        it('specifies libra-web-tools Issues as bugs URL', () => {
        ...
        it('specifies libra-web-tools deep-link homepage', () => {
        ...
        it('specifies a repository deep-linking into the libra-web-tools monorepo', () => {
